    ...
    ventana.addKeyListener(new KeyListener() {
        ...
        if(e.getKeyCode()== KeyEvent.VK_UP){
            ...
            if( serpiente.get(0).getY()>0 ){
               y = -desplazamiento;
               x = 0;
               serpiente.get(0).setIcon(new ImageIcon("sprite/2.png"));//hacer sprites
            }
            if(bandera==0){
              tiempo.start();
              bandera=1;
        ...
        if(e.getKeyCode()== KeyEvent.VK_DOWN){
            ...
            if( serpiente.get(0).getY()<600 ){
               y = desplazamiento;
               x = 0;
               serpiente.get(0).setIcon(new ImageIcon("sprite/4.png"));//hacer sprites
        ...
        if(e.getKeyCode()== KeyEvent.VK_LEFT){
            System.out.println("izquierda");
              if( serpiente.get(0).getX()>0 ){
               y = 0;
               x = -desplazamiento;
               serpiente.get(0).setIcon(new ImageIcon("sprite/3.png"));//hacer sprites
        ...
        if(e.getKeyCode()== KeyEvent.VK_RIGHT){
            System.out.println("derecha");
              if( serpiente.get(0).getX()<600   ){
               y = 0;
               x = desplazamiento;
                serpiente.get(0).setIcon(new ImageIcon("sprite/1.png"));//hacer sprites
